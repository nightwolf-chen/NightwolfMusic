...
.STYLE3 {font-family: "新宋体"; font-weight: bold; }
.myhead1 {		height: 200px;
	margin-top: 30px;
	margin-right: auto;
	margin-bottom: 10px;
	margin-left: auto;
...
<div class="struct">
  <div class="myhead1">
    ...
    <div class="intro">
      ...
      <form id="form1" name="form1" method="post" action="">
        <label><span class="STYLE3">音乐搜索</span>
    ...
    <div class="login">
      <form id="form3" name="form3" method="post" action="">
        ...
        <p align="center">
          <label>
          <input class="button" type="submit" name="Submit3" value="登录" />
          </label>
        </p>
        <p align="center">register ForgetPassword </p>
      </form>
    </div>
    <p>&nbsp;</p>
  ...
  <div class="main">
    <% while ((Recordset1_hasData)&&(Repeat1__numRows-- != 0)) { %>
      <div class="myitem">
        <table width="1092" border="0" bordercolor="#F0F0F0">
          <tr>
            <td width="37" height="25">&nbsp;</td>
            <td width="377">歌曲：<%=(((Recordset1_data = Recordset1.getObject("SongName"))==null || Recordset1.wasNull())?"":Recordset1_data)%></td>
            <td width="291">歌手：<%=(((Recordset1_data = Recordset1.getObject("SingerName"))==null || Recordset1.wasNull())?"":Recordset1_data)%></td>
            <td width="103">试听</td>
            <td width="104">下载</td>
            <td width="154">&nbsp;</td>
          </tr>
