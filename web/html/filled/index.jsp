...
.mynavigator .navibar .mybutton {
    ...
    <body>
        <div class="struct">
            <div class="foot">Enjoy this moment.</div>
            <div class="mynavigator">
   <div class="navibar" ><input class = "mybutton" type="button" value="找歌" onClick="window.location='/NightwolfMusic/'"/></div>
   <div class="navibar" ><input class = "mybutton" type="button" value="歌曲推荐" onClick="window.location='/NightwolfMusic/recommendation.jsp'"/></div>
   <%
   if(session.getAttribute("username") != null){
       String username = (String)session.getAttribute("username");
   out.println("<div class=\"navibar\" ><input class = \"mybutton\" type=\"button\" value=\"我的主页\" onClick=\"window.location='/NightwolfMusic/user.jsp?username="+username+"'\"/></div>");
   out.println("<div class=\"navibar\" ><input class = \"mybutton\" type=\"button\" value=\"退出登录\" onClick=\"window.location='/NightwolfMusic/quit.jsp'\"/></div>");
             }
   %>
   <%
        if(session.getAttribute("username") == null){
        out.println("<div class=\"navibar\" ><input class = \"mybutton\" type=\"button\" value=\"登录\"  onclick=\"window.location='/NightwolfMusic/login.jsp'\" /></div>") ;
        out.println("<div class=\"navibar\" ><input class = \"mybutton\" type=\"button\" value=\"注册\" onClick=\"window.location='/NightwolfMusic/register.jsp'\"/></div>");
               }
   %>
           </div>
            <div class="myhead1">
                ...
                <div class="intro">
                    <p>跟随着自由的心，聆听来自灵魂的声音，爱音乐</p>
                    <form id="form2" name="form2" method="post" action="/NightwolfMusic/html/filled/index.jsp" charset="gb2312">
                        <label>
                            <div align="center"><span class="STYLE3">找音乐</span>:
                                <input name="key" type="text" />
                                <input type="submit" name="searchButton" value="搜索" />
                                <input type="button" name="recommendation" value="音乐推荐" />
                            </div>
                            <div alian="center">
                            </div>>
                        </label>
               ...
               %>
                <div class="myitem">
                    <table width="769" border="0" bordercolor="">
                        <tr>
                            <td width="323" height="25">歌曲：<%=orisongName%></td>
                            <td width="338" ><a href="/NightwolfMusic/SingerInfo.jsp?singerid=<%=singerId%>">歌手：<%=(((Recordset1_data = Recordset1.getObject("SingerName")) == null || Recordset1.wasNull()) ? "" : Recordset1_data)%></a></td>
                            <td width="57"><a href="/NightwolfMusic/Player2.jsp?songid=<%=songId%>&songname=<%=songName%>&singerid=<%=singerId%>&singername=<%=singerName%>" target="_blank">试听</a></td>
                            <td width="33"><a href="/NightwolfMusic/html/filled/Download.jsp?songid=<%=songId%>" target="blank" >下载</a></td>
                        </tr>
                    </table>
                </div>
                <%
            ...
            <div class="foot2" fontsize="16" >Copyright 2011 nightwolf all rignt resered.Powered by Nightwolf-Chen. </div>
        </div>
    </body>
</html>
<%
