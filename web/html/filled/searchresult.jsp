...
String sql="SELECT * from spiderting2 where songName or singerName like '%"+key+"%'" ;
PreparedStatement StatementRecordset1 = ConnRecordset1.prepareStatement(sql);
System.out.println("sql:"+sql) ;
//StatementRecordset1.setString(1, key);
...
<div class="foot">Enjoy this moment.</div>
  <div class="myhead1">
    ...
    <div class="intro">
      ...
      <form id="form2" name="form2" method="post" action="searchresult.jsp">
        <label>
      ...
      <div class="myitem">
        <table width="769" border="0" bordercolor="">
          <tr>
            ...
            <td width="57"><a href="../../Player2.jsp?songid=<%=(((Recordset1_data = Recordset1.getObject("SongId"))==null || Recordset1.wasNull())?"":Recordset1_data)%>"  target="_blank">试听</a></td>
