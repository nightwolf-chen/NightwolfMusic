        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="metro<%=countStr%>">
                    ...
                    <div><h5><a href="JPlayerTest.jsp?songid=<%=songId%>&songname=<%=songName%>&singerid=<%=singerId%>&singername=<%=singerName%>" target="_blank">试听<i class="icon-play icon-white"></i></a>
